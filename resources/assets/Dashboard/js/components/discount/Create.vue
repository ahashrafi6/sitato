                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <div class="controls">
                                    ...
                                    <v-select multiple v-model="create_form.product" label="label" dir="rtl" @search="searchProduct" :options="products" :filterable="false"
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <div class="controls">
                                    ...
                                    <date-picker placeholder="انتخاب تاریخ" locale="fa,en" format="YYYY-M-D HH:mm" v-model="create_form.start_at" name="date" type="datetime"></date-picker>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="form-group">
                                <div class="controls">
                                    ...
                                    <date-picker placeholder="انتخاب تاریخ" locale="fa,en" format="YYYY-M-D HH:mm" v-model="create_form.expire_at" name="date" type="datetime"></date-picker>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        ...
        store() {
            this.create_form.post('/dashboard/discounts').then(({data}) => {
                if (data.operator) {
