    ...
    <section>
        <div class="card">
            <div class="card-content">
                <div class="card-body">
                    <form action="/dashboard/subscribe/{{ $subscribe->id }}" method="POST"
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        ...
                                        <input name="fa_title" type="text" class="form-control text-left"
                                               placeholder="عنوان" value="{{ $subscribe->fa_title }}" required
                                               dir="ltr">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="controls">
                                        ...
                                        <input disabled name="en_title" type="text" class="form-control text-left"
                                               placeholder="عنوان لاتین" value="{{ $subscribe->en_title }}" required
                                               dir="ltr">
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        ...
                                        <input name="price" type="text" class="form-control" placeholder="به تومان"
                                               value="{{ $subscribe->price }}" required>
                                ...
                                <div class="form-group">
                                    <div class="controls">
                                        ...
                                        <textarea name="items" class="form-control"
                                                  placeholder="با کاما (,) جداشوند">{{ $subscribe->items }}</textarea>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <div class="controls">
                                        ...
                                        @if($subscribe->icon)
                                            <img src="{{ img_url($subscribe->icon) }}" width="100px" height="100px">
                                        @endif
