...
<div class="dir-rtl">
    <div class="grid grid-cols-12 gap-3 mt-5 mb-8">
        <div class="col-span-12 mb-3 lg:mb-0">
            <h4 class="text-2xl font-bold mb-2 dark:text-white">پشتیبانی ها</h4>
            <p class="text-sm text-gray-500 dark:text-gray-400">لیست پشتیبانی های شما</p>
        </div>
    </div>
                ...
                <div class="rounded-lg p-5 bg-white dark:bg-gray-700 hover:shadow-xl duration-200 relative mb-5">
                    <div class="flex items-center justify-between text-sm">
                        <div class="flex items-center gap-8">
                            ...
                            @if($item['type'] == '6month')
                                <span class="text-gray-500">تمدید پشتیبانی 6 ماهه</span>
                            @elseif($item['type'] == 'service')
                                <span class="text-gray-500">سرویس پشتیبانی 6 ماهه</span>
                            @else
                                <span class="text-gray-500">پشتیبانی پیش فرض 6 ماهه</span>
                            @endif
