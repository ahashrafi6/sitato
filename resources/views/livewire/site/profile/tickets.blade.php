    ...
    <div class="dir-rtl">
        <div class="grid grid-cols-12 gap-3 mt-5 mb-8">
            <div class="col-span-10 mb-3 lg:mb-0">
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">لیست تیکت های شما</p>
            </div>
            <div class="col-span-2 flex justify-end items-center">
                <a class="btn btn-primary" href="{{ route('tickets.create') }}">ارسال تیکت</a>
            </div>
